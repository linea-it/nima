...
def NIMAmanager(inputParametersFile, log_file):
    ...
    # ========================== sc_AstDySMPC2NIMA ==========================
    executeScript("./sc_AstDySMPC2NIMA.sh",
...
if __name__ == "__main__":
    ...
    if args.path is not None and os.path.exists(os.environ.get("DIR_INPUTS")) is False:
        os.symlink(args.path, os.environ.get("DIR_INPUTS"))

    if args.path is None and os.path.exists(os.environ.get("DIR_INPUTS")) is False:
